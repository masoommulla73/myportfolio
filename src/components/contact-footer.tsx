    ...
    <footer id="contact" className="w-full h-full bg-[#0f172a] text-white overflow-hidden z-0 flex flex-col justify-between pt-12">
      ...
      <div className="max-w-[1600px] mx-auto w-full px-6 lg:px-16 flex flex-col gap-12 relative z-10 flex-grow mt-12 lg:mt-24">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-16 lg:gap-24 w-full">
          ...
          <div className="lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-8 border-t border-l border-white/10 w-full">
            
            <div className="flex flex-col gap-4 border-b border-r border-white/10 p-6 lg:p-10 hover:bg-white/5 transition-colors">
              <h4 className="text-emerald-400 text-xs font-black uppercase tracking-widest">Location</h4>
              <p className="text-xl lg:text-2xl font-bold uppercase tracking-tight leading-tight">
            ...
            <div className="flex flex-col gap-4 border-b border-r border-white/10 p-6 lg:p-10 hover:bg-white/5 transition-colors sm:col-span-2">
              <h4 className="text-emerald-400 text-xs font-black uppercase tracking-widest">Direct Contact</h4>
              <a href={`mailto:${SITE_CONTENT.contactEmail}`} className="text-2xl lg:text-4xl font-bold hover:text-emerald-400 transition-colors break-all">
